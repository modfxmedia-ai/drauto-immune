...
export const CONDITIONS_LINKS = [
  ...
  { label: "Celiac & Gluten Intolerance", href: "/celiac-disease-and-gluten-intolerance/" },
...
export const SOCIAL_LINKS = [
  {
    label: "Facebook",
    href: "https://www.facebook.com/profile.php?id=100083119431247",
    icon: "facebook",
  },
  {
    label: "Tiktok",
    href: "https://www.tiktok.com/@drautoimmune",
    icon: "tiktok",
  },
  {
    label: "Instagram",
    href: "https://www.instagram.com/dr_autoimmune/",
    icon: "instagram",
  },
] as const;

export const MISSION_BLURB =
  "At Dr. Autoimmune, we provide personalized, root-cause care to uncover the source of your symptoms and support long-term wellness.";

export const CLINIC_LOCATION = "Boulder, CO";
